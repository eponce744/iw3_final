...
public class User implements UserDetails {
	...
	//Eager: Cuando se pide un Usuario se cargan todos Roles compulsivamente 
	...
	//Itera mediante un bucle for-each (for (Tipo variable : Coleccion))
	//Para comparar "role" con los de la coleccion
	@Transient
	...
	//Transformamos una Lista de Roles a una Lista de objetos tipo SimpleGrantedAuthority
	//Stream pone la lista una detras de otra: role1, role2, role3
	//map: transforma role a tipo SimpleGrantedAuthority
	//collect: Crea una lista nuevamente, de los nuevos objetos transformados
	@Transient
	@Override
